    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="../index.php" class="brand-link">
                <span class="brand-text font-weight-light" style="margin-left: 10px;">Donde Estudio!</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="../img/logos/logo_v.png" class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
