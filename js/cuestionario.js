...
var preguntas = ["Le gustaria operar una imprenta.", "Le gustaria estudiar las causas de los terremotos.", "Le gustaria plantar y cosechar cultivos.", "Le gustaria reemplace la ventana y el guardabarros de un automóvil.", "Le gustaria analizar informes y registros.", "Le gustaria operar una máquina.", "Le gustaria trabaja en una oficina.", "Le gustaria responder las preguntas de los clientes", "Le gustaria escribir informes.", "Le gustaria ayudar a exreclusos a encontrar trabajo.", "Le gustaria diseñar una autopista.", "Le gustaria planificar lecciones educativas.", "Le gustaria balancear una chequera.", "Le gustaria tomar una radiografía.", "Le gustaria escribir un programa de computadora.", "Le gustaria entrenar animales.", "Le gustaria estar a cargo de la replantación de bosques.", "Le gustaria actuar en un programa de televisión o película.", "Le gustaria resolver un robo.", "Le gustaria verifique la calidad de los productos.", "Le gustaria construir un aeropuerto.", "Mantenga los registros comerciales de la empresa.", "Juntar herramientas pequeñas.", "Diseña un sitio web.", "Tutor estudiantes.", "Trabajar en un zoológico.", "Cuidar niños.", "Planificar dietas especiales.", "Coreografía un baile.", "Presiona o muestra apoyo por una causa.", "Vende ropa.", "Trabaja con tus manos.", "Trabajo en un parque de diversiones.", "Venta de seguros.", "Aprender sobre grupos étnicos.", "Administrar un sistema de información.", "Valorar el valor de una casa.", "Archivar libros en la biblioteca.", "Hacer objetos tridimensionales.", "Analizar escritura a mano.", "Diseñe sistemas de rociadores para interiores.", "Ejecute una máquina de coser de fábrica.", "Desarrollar políticas de personal.", "Entrenar caballos de carreras.", "Guarda un edificio de oficinas.", "Dirigir una tienda por departamentos.", "Escribir para un periódico.", "Usa una calculadora.", "Ayuda a personas en una clínica de salud mental.", "Remodelar casas antiguas.", "Cuidado de niños pequeños.", "Localiza a una persona desaparecida."];
